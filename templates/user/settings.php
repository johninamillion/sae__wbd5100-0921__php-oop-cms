...
<main id="user-settings" class="main wrapper wrapper--inner">
    ...
    <form id="user-settings-update-email-form" class="form box" method="post">
        <div class="form__header">
    ...
    <form id="user-settings-update-password-form" class="form box" method="post">
        <div class="form__header">
    ...
    <form id="user-settings-delete-form" class="form box" method="post">
        <div class="form__header">
